...
if ($_SERVER["REQUEST_METHOD"] == "POST") {
    ...
    $sql = "SELECT * FROM Kaprodi WHERE nipkp='$nipkp'";
    $result = $conn->query($sql);

    if ($result->num_rows > 0) {
        $row = $result->fetch_assoc();
        if (password_verify($pswrd, $row['password'])) {
            $_SESSION['nipkp'] = $nipkp;
            header('Location: dashboard.php');
            exit;
        } else {
            echo "Password salah.";
...
<body>
    <header>
        <nav class="navbar">
            <div class="logo">
                <img src="../images/logoUnpri.png" alt="logo Unpri" style="height: 35px;">
            </div>
            <ul>
                    ...
                    <form action="login.php" method="POST">
                        <div class="input-boxes">
                            <div class="input-box">
                                ...
                                <input type="text" name="nipkp" placeholder="Masukkan NIP anda" required>
                            </div>
                            <div class="input-box">
                ...
                <div class="signup-form">
                    ...
                    <form action="signup.php" method="POST">
                        <div class="input-boxes">
                            ...
                            <div class="input-box">
                                <i class="fas fa-user"></i>
                                <input type="text" name="nipkp" placeholder="Enter your NIP" required>
                            </div>
                            <div class="input-box">
                                <i class="fas fa-envelope"></i>
